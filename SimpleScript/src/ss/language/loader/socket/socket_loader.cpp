...
namespace ss {
    void load_socket(command_processor* cp) {
        ...
        cp->set_function(new ss::function("closeUDP", [](const size_t argc, string* argv) {
            if (argc != 1)
                expect_error("1 argument(s), got " + std::to_string(argc));
        ...
        cp->set_function(new ss::function("poll", [](const size_t argc, string* argv) {
            if (argc != 1)
                expect_error("1 argument(s), got " + std::to_string(argc));
        ...
        cp->set_function(new ss::function("recv", [](const size_t argc, const string* argv) {
            if (!argc)
                expect_error("1 argument(s), got " + std::to_string(argc));
        ...
        cp->set_function(new ss::function("recvFrom", [](const size_t argc, string* argv) {
            if (!argc)
                expect_error("1 argument(s), got " + std::to_string(argc));
        ...
        cp->set_function(new ss::function("send", [](const size_t argc, string* argv) {
            if (argc != 2)
                expect_error("2 argument(s), got " + std::to_string(argc));
        ...
        cp->set_function(new ss::function("sendTo", [](const size_t argc, string* argv) {
            if (argc != 2)
                expect_error("2 argument(s), got " + std::to_string(argc));
        ...
        cp->set_function(new ss::function("TCPClient", [](const size_t argc, string* argv) {
            if (argc != 2)
                expect_error("2 argument(s), got " + std::to_string(argc));
        ...
        cp->set_function(new ss::function("TCPServer", [](const size_t argc, string* argv) {
            if (argc != 2)
                expect_error("2 argument(s), got " + std::to_string(argc));
        ...
        cp->set_function(new ss::function("UDPClient", [](const size_t argc, string* argv) {
            if (argc != 2)
                expect_error("2 argument(s), got " + std::to_string(argc));
        ...
        cp->set_function(new ss::function("UDPServer", [](const size_t argc, string* argv) {
            if (argc != 1)
                expect_error("1 argument(s), got " + std::to_string(argc));
